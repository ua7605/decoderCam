...
class AgentListenerDust(object):
    ...
    def _register_listener(self):
        self.dust_comm.register_listener("cam-data-received-to-cam-server") # Todo Make in the DUST configuration.json a topic with name cam-data-received-to-cam-server
